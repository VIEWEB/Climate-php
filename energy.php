                ...
                <div class="page-content-1fr-left-1">
                    ...
                    <div class="data-qua">
                        ...
                        <div class="data-qua-box">
                            <span class="data-qua-single-box" style="background-color:#E69138" title="Fuel Combustion Activities">1A</span>
                            <span class="data-qua-single-box" style="background-color:#E16565" title="Fugitive Emissions from Fuel">1B</span>
                            <span class="data-qua-single-box" style="background-color:#E16565" title="Carbon Dioxide Transport & Storage">1C</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-content-2r-bottom">
            <h2>Key Highlights</h2>
                <div class="key-highlight-content">
                    ...
                    <p class="read-more-para">Renewable energy policies aim to curb power sector emissions, but rising electricity and transport demand seem to offset potential gains.<a href="https://climatedot.org/blog/energy-climate-dashboard" target="_blank"><img src="/images/add.png" width="22px" height="22px" style="margin-bottom:-6px;padding-left:5px;"></a></p>
                </div>
        </div>
    </div>
    <script>
